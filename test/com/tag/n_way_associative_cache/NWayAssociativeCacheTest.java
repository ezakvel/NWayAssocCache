...
public class NWayAssociativeCacheTest {
    ...
    public void setUp() throws CacheSizeConstructionException, InstantiationException, IllegalAccessException, NoSuchMethodException, IllegalArgumentException, InvocationTargetException {
        myCache = new NWayAssociativeCache<>(null, 4); //instantiating a 4-way associative cache
        defaultSizeCache = new NWayAssociativeCache<>(null, 4, 32); //instantiating a 4-way associative cache
        lru = new LRU();
        mru = new MRU();
    }
